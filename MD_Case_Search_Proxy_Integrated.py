import time
import pandas as pd
from seleniumwire import webdriver  # Changed from selenium to seleniumwire for proxy support
...
# ==========================================
# 🛑 PROXY CONFIGURATION (WEBSHARE / OTHERS)
# ==========================================
# Replace these variables with the proxy details from Webshare
PROXY_USER = "yodzgxmr"
PROXY_PASS = "6h1gsqrqowmc"
...
driver = webdriver.Chrome(
    ...
    options=options,
    seleniumwire_options=proxy_options  # This line attaches the proxy
)
